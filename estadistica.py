...
Original file is located at
    https://colab.research.google.com/drive/1eTH7gCeDIbuN-d-_pfUNP9uQ40bC7VVT
"""
...
import matplotlib.pyplot as plt
plt.hist(altura, bins=5)  # bins define el número de barras en el histograma
plt.xlabel("Valor")
plt.ylabel("Frecuencia")
plt.title("Histograma de la altura")
plt.show()

plt.hist(cintura, bins=5)  # bins define el número de barras en el histograma
plt.xlabel("Valor")
plt.ylabel("Frecuencia")
